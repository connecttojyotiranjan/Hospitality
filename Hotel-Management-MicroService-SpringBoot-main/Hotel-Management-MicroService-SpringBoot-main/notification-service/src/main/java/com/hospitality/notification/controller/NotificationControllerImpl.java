...
import com.hospitality.notification.configuration.MailConfiguration;
import com.hospitality.notification.dto.EmailContentDto;
...
public class NotificationControllerImpl implements NotificationController {
	...
	public void sendProjectStatusEmail(ConsumerRecord<String, String> record) {
		...
		try {
			mailConfiguration.sendmail("jyotiranjan.tc@gmail.com",
					new EmailContentDto("Hotel management service", record.value(), "text/html"));
			mailConfiguration.sendmail("mjyotira@gmail.com",
					new EmailContentDto("Hotel management service", record.value(), "text/html"));
		} catch (Exception e) {
			e.printStackTrace();
		}
